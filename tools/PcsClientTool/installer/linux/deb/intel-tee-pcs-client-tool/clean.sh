...
PACKAGE_NAME="intel-tee-pcs-client-tool"
COMMON_DIR="$(cd "${SCRIPT_DIR}/../../common/${PACKAGE_NAME}" && pwd)"

# Remove various intel-tee-pcs-client-tool artifacts
...
# Remove extracted directories except intel-tee-pcs-client-tool-1.0
