...
python ${SCRIPT_DIR}/gen_source.py --bom=BOMs/intel-tee-pcs-client-tool.txt --installdir=pkgroot/intel-tee-pcs-client-tool --deliverydir=${ROOT_DIR}
python ${SCRIPT_DIR}/gen_source.py --bom=BOMs/intel-tee-pcs-client-tool-package.txt --cleanup=false --deliverydir=${ROOT_DIR}
